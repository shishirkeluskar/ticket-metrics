...
//  private OverallScoreService service;
//
//  @BeforeEach
//  void setUp() {
//    ratingMapper = mock(RatingMapper.class);
//    dailyScoreCacheStore = mock(DailyScoreCacheStore.class);
//    service = new OverallScoreService(dailyScoreCacheStore);
//  }
//
//  @Test
//  void testGetOverallScore_noRatings() {
//    when(dailyScoreCacheStore.getScoreForDate(any(LocalDate.class)))
//        .thenReturn(new DailyAggregateScore(
//            LocalDate.now(),
//            BigDecimal.ZERO,
//            BigDecimal.ZERO
//        ));
//
//    BigDecimal score = service.getOverallScore(LocalDate.now(), LocalDate.now());
...
//
//    BigDecimal score = service.getOverallScore(LocalDate.now().minusDays(7), LocalDate.now());
